    ...
    : device(device), swapchain(swapchain)
{
    ...
    colorAttachment.samples = settings.Renderer.msaaSampleCount;
    ...
    depthAttachment.samples = settings.Renderer.msaaSampleCount;
    ...
    VkAttachmentReference colorAttachmentResolvRef{};
    colorAttachmentResolvRef.attachment = 2;
    colorAttachmentResolvRef.layout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;
    ...
    subpass.pResolveAttachments = &colorAttachmentResolvRef;
