#include "tools.h"
#if !defined NDEBUG
std::unordered_map<VkResult, ErrorDetail> errorDetails = {

    // SUCCESS CODES
    {VK_NOT_READY, {"VK_NOT_READY", "A fence or query has not yet completed", false}},
    {VK_TIMEOUT, {"VK_TIMEOUT", "A wait operation has not completed in the specified time", false}},
    {VK_EVENT_SET, {"VK_EVENT_SET", "An event is signaled", false}},
    {VK_EVENT_RESET, {"VK_EVENT_RESET", "An event is unsignaled", false}},
    {VK_INCOMPLETE, {"VK_INCOMPLETE", "A return array was too small for the result", false}},
    {VK_SUBOPTIMAL_KHR,
     {"VK_SUBOPTIMAL_KHR",
      "A swapchain no longer matches the surface properties exactly, but can still be used to present to "
    ...
    {VK_THREAD_DONE_KHR,
     {"VK_THREAD_DONE_KHR",
      "A deferred operation is not complete but there is no work remaining to assign to additional threads.", false}},
    {VK_OPERATION_DEFERRED_KHR,
     {"VK_OPERATION_DEFERRED_KHR", "A deferred operation was requested and at least some of the work was deferred.", false}},
    {VK_OPERATION_NOT_DEFERRED_KHR,
     {"VK_OPERATION_NOT_DEFERRED_KHR", "A deferred operation was requested and no operations were deferred.", false}},
    ...
    {VK_ERROR_DEVICE_LOST, {"VK_ERROR_DEVICE_LOST", "The logical or physical device has been lost."}},
    ...
    {VK_ERROR_INVALID_SHADER_NV,
     {"VK_ERROR_INVALID_SHADER_NV", "One or more shaders failed to compile or link. More details are reported back to the "
    ...
    {VK_ERROR_OUT_OF_POOL_MEMORY,
     {"VK_ERROR_OUT_OF_POOL_MEMORY",
      ...
      "to accommodate the new allocation. If the failure was definitely due to fragmentation of the pool, "
    ...
    {VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS,
     {"VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS",
      "A buffer creation or memory allocation failed because the requested address is not available. A shader group handle "
      "assignment failed because the requested shader group handle information is no longer valid."}},
    ...
    {VK_ERROR_COMPRESSION_EXHAUSTED_EXT,
     {"VK_ERROR_COMPRESSION_EXHAUSTED_EXT", "An image creation failed because internal resources required for compression are "
                                            "exhausted. This must only be returned when fixed-rate compression is requested."}},
    ...
    {VK_ERROR_INCOMPATIBLE_SHADER_BINARY_EXT,
     {"VK_ERROR_INCOMPATIBLE_SHADER_BINARY_EXT", "The provided binary shader code is not compatible with this device."}},
    {VK_ERROR_UNKNOWN,
